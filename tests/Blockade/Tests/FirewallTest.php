...
class FirewallTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testNotLoggedIn()
    {
        ...
        $this->setExpectedException('Blockade\Exception\AuthenticationException');
    ...
    public function testLoggedIn()
    {
        ...
        $this->driver->expects($this->once())
                     ...
                     ->will($this->returnValue(false));
        $this->assertFalse($this->firewall->check($this->createRequest('/bar')));
        $this->setExpectedException('Blockade\Exception\AuthorizationException');
        $this->firewall->check($this->createRequest('/foo'));
    }
    ...
    public function testAnonLoggedIn()
    {
        ...
        $this->firewall->addRule($matcher, 'ANON');
        $this->assertFalse($this->firewall->check($this->createRequest('/bar')));
        $this->setExpectedException('Blockade\Exception\AnonymousException');
        $this->firewall->check($this->createRequest('/foo'));
    }
